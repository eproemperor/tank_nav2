...
//
// template Trajectory poly_interpo::minimumSnapInterpolation<1>(const Eigen::Matrix<double, 1, 4>
// &init_state,
//                                                            const Eigen::Matrix<double, 1, 4> &goal_state,
//                                                            const Eigen::Matrix<double, 1, -1> &waypoint,
//                                                            const VecDf &ts);
//
// template Trajectory poly_interpo::minimumSnapInterpolation<2>(const Eigen::Matrix<double, 2, 4>
// &init_state,
//                                                            const Eigen::Matrix<double, 2, 4> &goal_state,
//                                                            const Eigen::Matrix<double, 2, -1> &waypoint,
//                                                            const VecDf &ts);
//
// template Trajectory poly_interpo::minimumSnapInterpolation<3>(const Eigen::Matrix<double, 3, 4>
// &init_state,
