...
std::set<double> math_utils::RootFinderPriv::eigenSolveRealRoots(
...
double math_utils::RootFinderPriv::safeNewton(const F & func,
  const DF & dfunc,
  const double & l,
  const double & h,
  const double & tol,
...
double math_utils::RootFinderPriv::shrinkInterval(
...
void math_utils::RootFinderPriv::recurIsolate(double l,
  double r,
  double fl,
  double fr,
  int lnv,
...
std::set<double> math_utils::RootFinderPriv::isolateRealRoots(
  const Eigen::VectorXd & coeffs, double lbound, double ubound, double tol)
{
  std::set<double> rts;
...
std::set<double> math_utils::RootFinder::solvePolynomial(
