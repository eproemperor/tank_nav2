...
int main(int argc, char ** argv)
{
  ...
  SQProblem joints_velocities(7,
    6);  // create qp problem of 7 variables and 6 constraints with the hessian matrix set with the identity
