...
extern "C"
{
  ...
  void sci_QProblem_init(real_t * H,
    real_t * g,
    real_t * A,
    real_t * lb,
    real_t * ub,
    ...
    int_t * nWSRout,
    real_t * y);
  void sci_QProblemB_init(real_t * H,
    real_t * g,
    real_t * lb,
    real_t * ub,
    int_t * nV,
    ...
    int_t * nWSRout,
    real_t * y);
  void sci_SQProblem_init(real_t * H,
    real_t * g,
    real_t * A,
    real_t * lb,
    real_t * ub,
  ...
  void sci_QProblem_hotstart(real_t * g,
    real_t * lb,
    real_t * ub,
    real_t * lbA,
    real_t * ubA,
    ...
    int_t * nWSRout,
    real_t * y);
  void sci_QProblemB_hotstart(real_t * g,
    real_t * lb,
    real_t * ub,
    int_t * nWSR,
    real_t * x,
    ...
    int_t * nWSRout,
    real_t * y);
  void sci_SQProblem_hotstart(real_t * H,
    real_t * g,
    real_t * A,
    real_t * lb,
    real_t * ub,
