...
extern "C" void DPOTRF(
  const char * uplo, const la_uint_t * _n, double * a, const la_uint_t * _lda, la_int_t * info)
{
  double sum;
  la_int_t i, j, k;
...
extern "C" void SPOTRF(
  const char * uplo, const la_uint_t * _n, float * a, const la_uint_t * _lda, la_int_t * info)
{
  float sum;
  la_int_t i, j, k;
  la_int_t n = (la_int_t)(*_n);
...
extern "C" void DTRTRS(const char * UPLO,
  const char * TRANS,
  const char * DIAG,
  const la_uint_t * N,
...
extern "C" void STRTRS(const char * UPLO,
  const char * TRANS,
  const char * DIAG,
  const la_uint_t * N,
  const la_uint_t * NRHS,
...
extern "C" void DTRCON(const char * NORM,
  const char * UPLO,
  const char * DIAG,
  const la_uint_t * N,
  double * A,
...
extern "C" void STRCON(const char * NORM,
  const char * UPLO,
  const char * DIAG,
  const la_uint_t * N,
  float * A,
