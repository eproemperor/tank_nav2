  ...
  VisibilityStatus localVisibilityStatus)
{
  ...
  if (errorVisibility == VS_VISIBLE)
    return throwMessage(
      Enumber, additionaltext, functionname, filename, linenumber, localVisibilityStatus, "ERROR");
  else
    return Enumber;
}
  ...
  VisibilityStatus localVisibilityStatus)
{
  ...
  if (warningVisibility == VS_VISIBLE)
    return throwMessage(
      Wnumber, additionaltext, functionname, filename, linenumber, localVisibilityStatus, "WARNING");
  else
    return Wnumber;
}
  ...
  VisibilityStatus localVisibilityStatus)
{
  ...
  if (infoVisibility == VS_VISIBLE)
    return throwMessage(
      Inumber, additionaltext, functionname, filename, linenumber, localVisibilityStatus, "INFO");
  else
    return Inumber;
}
