...
returnValue printCopyrightNotice()
{
  ...
  myPrintf(
    "\nqpOASES -- An Implementation of the Online Active Set Strategy.\nCopyright (C) 2007-2017 by Hans "
    "Joachim Ferreau, Andreas Potschka,\nChristian Kirches et al. All rights reserved.\n\nqpOASES is "
    "distributed under the terms of the \nGNU Lesser General Public License 2.1 in the hope that it will "
 ...
 */
returnValue writeIntoFile(
  const int_t * const integer, int_t n, const char * datafilename, BooleanType append)
{
#ifndef __SUPPRESSANYOUTPUT__
 ...
 */
returnValue writeIntoMatFile(
  FILE * const matFile, const int_t * const data, int_t nRows, int_t nCols, const char * name)
{
...
returnValue getKktViolation(int_t nV,
  ...
  BooleanType hasIdentityHessian)
{
  return getKktViolation(
    nV, 0, H, g, 0, lb, ub, 0, 0, x, y, stat, feas, cmpl, workingSetB, 0, hasIdentityHessian);
}
