...
bool RayCaster::step(Eigen::Vector3d & ray_pt)
{
  ...
  //                std::endl; std::cout << "start: " << start_x_d_ << ", " << start_y_d_ << ", " <<
  //                start_z_d_ << std::endl; std::cout << "end: " << end_x_d_ << ", " << end_y_d_ << ", " <<
  //                end_z_d_ << std::endl; std::cout << "end_id: " << end_x_i_ << ", " << end_y_i_ << ", "
  //                << end_z_i_ << std::endl; std::cout << "cur_id: " << cur_ray_pt_id_x_ << ", " <<
  //                cur_ray_pt_id_y_ << ", " << cur_ray_pt_id_z_
  //                          << std::endl;
  //                std::cout << "t_to_bound
