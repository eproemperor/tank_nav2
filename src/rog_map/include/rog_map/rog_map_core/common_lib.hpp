...
static super_utils::Vec3f lineBoxIntersectPoint(const super_utils::Vec3f & pt,
  const super_utils::Vec3f & pos,
...
static bool lineIntersectBox(super_utils::Vec3f L1,
  super_utils::Vec3f L2,
  super_utils::Vec3f B1,
  super_utils::Vec3f B2,
