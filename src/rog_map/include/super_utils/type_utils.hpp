...
static const std::vector<std::string> RET_CODE_STR{"FAILED",
  "NO_NEED",
  "SUCCESS",
  "FINISH",
  "NEW_TRAJ",
...
const static std::vector<std::string> GridTypeStr{
  "UNDEFINED", "UNKNOWN", "OUT_OF_MAP", "OCCUPIED", "KNOWN_FREE", "FRONTIER"};
