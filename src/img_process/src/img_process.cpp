...
void ImgProcess::imageCallback(sensor_msgs::msg::Image rosImage)
{
    ...
    double distance_to_purple_entry = sqrt(pow(mapInfo[SENTRY].pos.x - mapInfo[PURPLEENTRY].pos.x, 2) + pow(mapInfo[SENTRY].pos.y - mapInfo[PURPLEENTRY].pos.y, 2));
    double distance_to_green_entry = sqrt(pow(mapInfo[SENTRY].pos.x - mapInfo[GREENENTRY].pos.x, 2) + pow(mapInfo[SENTRY].pos.y - mapInfo[GREENENTRY].pos.y, 2));
    double distance_to_purple_exit = sqrt(pow(mapInfo[SENTRY].pos.x - mapInfo[PURPLEEXIT].pos.x, 2) + pow(mapInfo[SENTRY].pos.y - mapInfo[PURPLEEXIT].pos.y, 2));
    double distance_to_green_exit = sqrt(pow(mapInfo[SENTRY].pos.x - mapInfo[GREENEXIT].pos.x, 2) + pow(mapInfo[SENTRY].pos.y - mapInfo[GREENEXIT].pos.y, 2));
